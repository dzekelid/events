...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/events/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-origin-requests-cpcode-get.md
x-common:
- type: x-base

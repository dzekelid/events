...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/akamai/etp-report-v1-configs-configid-threat-events-details-starttimesec,endtimesec,dimension,filters-get.md
x-common:
- type: x-base

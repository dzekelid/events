...
- name: Meetup
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/meetup/urlname-events-event-id-comments-comment-id-likes-post.md
x-common:
- type: x-base

...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/cisco-webex/apis.md
...
- name: Webex Teams Admin API - List Events (new messages)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/cisco-webex/events-get-openapi.md
- name: Webex Teams Admin API - Get Events Details
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/cisco-webex/events-event-get-openapi.md
- name: Webex Teams API - Create a webhook (all events, all rooms)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/cisco-webex/webhooks-post-openapi.md
x-common:

...
- name: Microsoft Graph API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/events/master/_listings/microsoft-graph/users-id-|-userprincipalname-calendargroup-calendars-id-events-get.md
x-common:
- type: x-change-loge

...
- name: Microsoft Graph API List Events
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/events/master/_listings/microsoft-graph/users-id-|-userprincipalname-calendars-id-events-get.md
x-common:
- type: x-change-loge
